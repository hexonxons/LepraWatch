...
public class Lepra
{
    ...
    public synchronized void login(String username, String password, boolean forever)
    {
        login(username, password, forever, null, null);
    }
    
    public synchronized void login(String username, String password, boolean forever, String recaptchaChallengeField, String recaptchaResponseField)
    {
        if(isAuthorized())
    ...
    public synchronized LepraStatus getLepraStatus()
    {
    ...
    public synchronized LepraProfile loadProfile(String login)
    {
        return mHttpClient.loadContent(LepraURI.getProfileURI(login), LepraProfileParser.getInstance());
    }
    
    public synchronized ArrayList<LepraPost> loadPosts(String leprosorium, String sorting)
    {
        Map<String, String> parameters = new HashMap<String, String>();
        parameters.put("csrf_token", mLepraContext.userContext.csrfToken);
